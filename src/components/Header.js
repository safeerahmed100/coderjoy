  ...
  return (
    <div className='Header w-screen bg-center	bg-cover	'>
      <div className='HeaderBg'></div>
        ...
        <img  className={`leftImg side ${switchImage ? 'switchSideRight' : ''}`} src={leftImg} alt='left' /> 
        ...
        <img  className={`rightImg side ${switchImage ? 'switchSideLeft' : ''}`} src={rightImg} alt='right'/>    
